...
# from models.survival.non_local import NLBlockND

# from models.survival.cbam import CBAM
...
class ResNet(nn.Module):
    ...
    def __init__(self,
        ...
        self.conv1 = nn.Sequential(
            Conv3d(n_input_channels,self.in_planes,kernel_size=3,stride=(1,2,2),padding=1,bias=False),
